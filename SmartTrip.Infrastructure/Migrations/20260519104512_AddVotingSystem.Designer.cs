...
namespace SmartTrip.Infrastructure.Migrations
{
    ...
    [Migration("20260519104512_AddVotingSystem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartTrip.Models.LocalEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SmartTrip.Models.Trip", b =>
                {
                    ...
                    b.Property<string>("RouteBack")
                        .HasColumnType("text");

                    b.Property<string>("RouteToDestination")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("SmartTrip.Models.Vote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("VotingItemId")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("VotingItemId");

                    b.ToTable("Votes");
                });

            modelBuilder.Entity("SmartTrip.Models.VotingItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SmartTrip.Models.VotingSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SmartTrip.Models.Vote", b =>
                {
                    b.HasOne("SmartTrip.Models.VotingItem", "VotingItem")
                        .WithMany("Votes")
                        .HasForeignKey("VotingItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("VotingItem");
                });

            modelBuilder.Entity("SmartTrip.Models.VotingItem", b =>
                {
                    b.HasOne("SmartTrip.Models.VotingSession", "VotingSession")
